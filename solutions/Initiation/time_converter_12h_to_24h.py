...
# '00:00' <= time <= '23:59'
# 
# Also interesting fact about "12:00 p.m." and "12:00 a.m.". The name of this fact is "Confusion at noon and        midnight" - problem using "p.m./ a.m." with this magical time "12:00". You can find information about this        inWikipediaor just google it.
# 
# 
# END_DESC
